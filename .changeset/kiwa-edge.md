---
"@kiwa-test/edge": patch
---

🎉 New package `@kiwa-test/edge` v1.0 — Edge runtime fetch handler test adapter (Issue #522、 v1.2 milestone 4/10).
...
- D1 database binding mock (SQL execute) — `@kiwa-test/orm` (#527) で testcontainers + Postgres 経路と整合検討。
