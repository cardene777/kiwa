...
🎉 New package `@kiwa-test/nuxt` v1.0 — Nuxt 3 Server Routes test adapter (Issue #496、 v1.1 milestone 5/7).
...
- `scripts/check-coverage-gates.mjs` PACKAGES + PKG_DIRS にnuxt 追加.
