---
"@kiwa-test/qwikcity": patch
---

🎉 New package `@kiwa-test/qwikcity` v1.0 — Qwik City routeAction\$ + routeLoader\$ + Endpoints test adapter (Issue #519、 v1.2 milestone 3/10).
...
This is the **final framework adapter** of v1.2 — `@kiwa-test/solidstart` (#518) + `@kiwa-test/qwikcity` (#519) で v1.2 framework 拡大が完了 (全ての主要 server-side framework に対応)、 残 v1.2 は Bun / Deno / Edge runtime / ORM / examples / hooks.server / sub-features の infrastructure 系。
