...
3 export (startQuery + dispatchQueryEvent + summarizeQuery)、 5 state (parsing / searching / reranking / facet-aggregating / completed) + 8 event。 10 behavior test。 systematic pattern 49 度目適用 (systematic law 継承 第 1 例)。
