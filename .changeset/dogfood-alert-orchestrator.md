---
'dogfood-alert-orchestrator': patch
---

feat: v1.17-3 — new Node.js style Prometheus AlertManager alert orchestrator dogfood app driven behind a provider-neutral `AlertOrchestratorAdapter`. Exercises the v1.17-1 `@kiwa-test/observability` `AlertRouter` end-to-end against a live AlertManager HTTP API path.
