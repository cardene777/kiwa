---
'dogfood-observability-dashboard': patch
---

feat: v1.17-2 — new Next.js App Router style Grafana dashboard dogfood app driven behind a provider-neutral `DashboardAdapter`. Exercises the v1.17-1 `@kiwa-test/observability` `DashboardMock` end-to-end against a real Prometheus HTTP API path.
