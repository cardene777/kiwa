...
dApp 向け Playwright E2E テストツール `dapp-e2e` のコア機能を構築する。
...
- AC 1: `pnpm install && pnpm -F @dapp-e2e/core build` が green で型エラーなし
...
- AC 7: foundry 未インストール時に `pnpm -F @dapp-e2e/cli doctor` が `anvil not found` を非ゼロ exit で報告する
- AC 8: `packages/core/package.json` で viem を `peerDependencies viem ^2` + `devDependencies viem ^2.21` として宣言し、runtime install では viem を巻き込まない (`pnpm install --filter @dapp-e2e/core --prod` で viem が node_modules に入らないこと)
...
| CLI | `dapp-e2e doctor` の foundry 検出 |
...
| `dapp-e2e init` の雛形生成 CLI | 別 Issue F |
...
| ファイル | 状態 |
|---|---|
| `/Users/cardene/Desktop/projects/dapp-e2e/package.json` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/pnpm-workspace.yaml` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/tsconfig.base.json` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/.gitignore` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/package.json` | **修正** (peerDependencies viem ^2 に変更) |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/tsconfig.json` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/tsup.config.ts` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/vitest.config.ts` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/types.ts` | **拡張** (10 RPC + event type 追加) |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/index.ts` | **拡張** (10 RPC dispatch + event emitter export) |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/tests/injector.test.ts` | **拡張** (6 → 14 ケース、新規 6 RPC + 反例) |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/tests/anvil.test.ts` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/cli/*` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/examples/basic-connect/package.json` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/examples/basic-connect/tsconfig.json` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/examples/basic-connect/playwright.config.ts` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/examples/basic-connect/tests/connect.spec.ts` | **拡張** (3 → 6 ケース、signTypedData / sendTransaction / accountsChanged) |

### 新規追加 (本 Issue で増える file)

| ファイル | 用途 |
|---|---|
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/fixture.ts` | Playwright `test.extend` で `dappE2eTest` fixture、page.exposeFunction で Node 側 dispatch |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/injector-script.ts` | `createInjectorScript` 専用、page context で `window.ethereum` proxy を立てる pure JS 文字列 |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/anvil.ts` | anvil child_process spawn / SIGTERM / port 採番 (`startAnvil` / `getFreePort` の実体、現状は index.ts に stub) |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/rpc-handlers.ts` | 10 RPC dispatch table + 反例ハンドラ (`method not supported`) |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/event-emitter.ts` | EventEmitter ラップ (`accountsChanged` / `chainChanged` / `connect` / `disconnect`) |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/tx.ts` | `eth_sendTransaction` 専用、viem `createWalletClient` + anvil broadcast |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/tests/event-emitter.test.ts` | 4 event 単体テスト |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/tests/tx.test.ts` | TX broadcast + receipt + revert 単体テスト (anvil 実 spawn) |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/tests/fixture.test.ts` | fixture 単体テスト (page.exposeFunction の wire-up) |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/cli/package.json` | 既存維持 |
| `/Users/cardene/Desktop/projects/dapp-e2e/packages/cli/src/index.ts` | doctor 実装 (現状 stub) |
| `/Users/cardene/Desktop/projects/dapp-e2e/README.md` | **修正** (viem MIT クレジット + Non-Goals + quickstart) |
| `/Users/cardene/Desktop/projects/dapp-e2e/.github/workflows/ci.yml` | 新規 (pnpm install + playwright browser cache + 全 test) |
| `/Users/cardene/Desktop/projects/dapp-e2e/LICENSE` | 新規 (MIT、本ツール自体のライセンス) |
...
- これにより `pnpm install --filter @dapp-e2e/core --prod` で viem が巻き込まれない (AC 8 検証可能)
...
- Issue F: CLI init (`dapp-e2e init` 雛形生成、Next.js / Vite template 対応)
