...
kiwa npm v0.1.0 公開準備の publish 基盤を確立する。
...
- 反例 2: `record` / `run` CLI subcommand を `kiwa` bin に追加する PR は壁打ち論点 5 違反 (Playwright codegen + `pnpm exec playwright test` で代替)
...
- `/Users/cardene/Desktop/projects/kiwa/.changeset/config.json`
- `/Users/cardene/Desktop/projects/kiwa/.changeset/README.md`
- `/Users/cardene/Desktop/projects/kiwa/.github/workflows/ci.yml`
- `/Users/cardene/Desktop/projects/kiwa/.github/workflows/release.yml`
- `/Users/cardene/Desktop/projects/kiwa/.npmignore`
- `/Users/cardene/Desktop/projects/kiwa/docs/RELEASING.md`

修正 3 file:

- `/Users/cardene/Desktop/projects/kiwa/package.json` (scripts: changeset / version-packages / release + devDep `@changesets/cli`)
- `/Users/cardene/Desktop/projects/kiwa/packages/core/package.json` (publishConfig + repository + license + keywords)
- `/Users/cardene/Desktop/projects/kiwa/packages/cli/package.json` (同上)
