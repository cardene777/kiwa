# spec: dapp-e2e-v0.1.0-roadmap

## タスクサマリ

dapp-e2e (PR #2 merge 済 MVP) を npm v0.1.0 で公開可能な品質に引き上げる。
...
- AC 3 (Issue #5 完了): `dapp-e2e init` がユーザー dApp プロジェクトに fixture import 済 `e2e/*.spec.ts` + `playwright.config.ts` + `package.json` script を生成する
...
- AC 6 (v0.1.0 publish): npmjs.com 上で `@dapp-e2e/core` `@dapp-e2e/cli` が v0.1.0 として公開され、`pnpm dlx @dapp-e2e/cli init` が外部プロジェクトで動作する
...
- `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/{rpc-handlers,tx,anvil,fixture,injector-script}.ts` 修正
- `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/tests/*.test.ts` 新規 negative test 追加
- `/Users/cardene/Desktop/projects/dapp-e2e/examples/basic-connect/{package.json,tests/connect.spec.ts}` viem deps 移動 + negative test 追加
- `/Users/cardene/Desktop/projects/dapp-e2e/README.md` personal_sign hex policy 明示

### Issue #4 (新規) — Changesets + CI + provenance

- `/Users/cardene/Desktop/projects/dapp-e2e/.changeset/config.json` 新規
- `/Users/cardene/Desktop/projects/dapp-e2e/.changeset/README.md` 新規
- `/Users/cardene/Desktop/projects/dapp-e2e/.github/workflows/ci.yml` 新規 (node 20/22 matrix)
- `/Users/cardene/Desktop/projects/dapp-e2e/.github/workflows/release.yml` 新規 (Changesets publish + provenance)
- `/Users/cardene/Desktop/projects/dapp-e2e/.npmignore` 新規 (or `files` field 整備)
- `/Users/cardene/Desktop/projects/dapp-e2e/package.json` scripts (`changeset` / `release` 追加)
- `/Users/cardene/Desktop/projects/dapp-e2e/packages/{core,cli}/package.json` publishConfig + provenance flag
- `/Users/cardene/Desktop/projects/dapp-e2e/CHANGELOG.md` 自動生成

### Issue #5 (新規) — CLI `init`

- `/Users/cardene/Desktop/projects/dapp-e2e/packages/cli/src/index.ts` argv dispatch 追加 (doctor + init)
- `/Users/cardene/Desktop/projects/dapp-e2e/packages/cli/src/commands/init.ts` 新規
- `/Users/cardene/Desktop/projects/dapp-e2e/packages/cli/src/templates/playwright.config.ts.tpl` 新規
- `/Users/cardene/Desktop/projects/dapp-e2e/packages/cli/src/templates/connect.spec.ts.tpl` 新規
- `/Users/cardene/Desktop/projects/dapp-e2e/packages/cli/tests/init.test.ts` 新規

### Issue #6 (新規) — README + docs/

- `/Users/cardene/Desktop/projects/dapp-e2e/README.md` 全面書き直し (quickstart + features + comparison)
- `/Users/cardene/Desktop/projects/dapp-e2e/docs/RPC.md` 新規 (10 RPC + anvilProxy fallback 一覧)
- `/Users/cardene/Desktop/projects/dapp-e2e/docs/EVENTS.md` 新規 (4 event + DappE2eApi)
- `/Users/cardene/Desktop/projects/dapp-e2e/docs/ERRORS.md` 新規 (EIP-1193 code 一覧 + error envelope 設計)
- `/Users/cardene/Desktop/projects/dapp-e2e/docs/MIGRATION.md` 新規 (v0.x → v0.y breaking change tracking)
- `/Users/cardene/Desktop/projects/dapp-e2e/docs/COMPARISON.md` 新規 (Synpress / wallet-mock との比較)

### Issue #7 (新規) — EIP-6963 announce

- `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/injector-script.ts` EIP-6963 announce event 追加
- `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/types.ts` Eip6963ProviderInfo 追加
- `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/src/fixture.ts` option で wallet info (name/icon/rdns) 受取
- `/Users/cardene/Desktop/projects/dapp-e2e/packages/core/tests/eip6963.test.ts` 新規
...
- dapp-e2e の差別化軸 = 「anvil ベース fork chain testing 特化の headless E2E fixture」、Synpress (実 wallet) / wallet-mock (mock) と補完関係
