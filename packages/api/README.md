...
`@kiwa-lab/api` is the Layer 2 adapter that turns a Layer 1 kiwa-design spec (with `mode = mock | live | hybrid`) into a runnable Vitest suite. It works with any Node-runnable HTTP framework:
...
```ts
import { setupApiServer } from "@kiwa-lab/api";
...
- [概要](https://cardene777.github.io/kiwa/libraries/foundation/api/)
- [はじめる](https://cardene777.github.io/kiwa/libraries/foundation/api/quickstart)
- [使い方](https://cardene777.github.io/kiwa/libraries/foundation/api/how-to)
- [リファレンス](https://cardene777.github.io/kiwa/libraries/foundation/api/reference)

編集元は [docs/libraries/foundation/api](../../docs/libraries/foundation/api/) です。
<!-- kiwa-docs:end -->
