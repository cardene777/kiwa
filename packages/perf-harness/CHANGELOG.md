...
- b0a7e8b: feat(v1.13-1): `@kiwa-lab/perf-harness` v0.1.0 — 5 target generic performance harness
  ...
  - Release-gate integration — emits a `QualityReport` with `perf.p95Ms` populated, compatible with `@kiwa-lab/quality-metrics` v0.2 11-axis evaluation
