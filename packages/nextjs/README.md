...
```bash
pnpm add -D @kiwa-lab/nextjs
```

## Why

Next.js Server Actions (`'use server'`) are async functions that can throw `redirect()`, mutate cookies, and call `revalidatePath()` — none of which return values. Integration-level testing through Playwright works but is slow and flaky. `@kiwa-lab/nextjs` lets you call the action **directly in Vitest** and assert on the captured side-effects.
...
- [概要](https://cardene777.github.io/kiwa/libraries/frameworks/nextjs/)
- [はじめる](https://cardene777.github.io/kiwa/libraries/frameworks/nextjs/quickstart)
- [使い方](https://cardene777.github.io/kiwa/libraries/frameworks/nextjs/how-to)
- [リファレンス](https://cardene777.github.io/kiwa/libraries/frameworks/nextjs/reference)

編集元は [docs/libraries/frameworks/nextjs](../../docs/libraries/frameworks/nextjs/) です。
<!-- kiwa-docs:end -->
