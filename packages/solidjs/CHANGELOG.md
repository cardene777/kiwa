...
- 🎉 New package `@kiwa-test/solidjs` v0.1 — SolidJS Signal + Effect + createResource + Suspense boundary test adapter (Issue #813, v1.19-1a).
  ...
  - `scripts/check-coverage-gates.mjs` に `@kiwa-test/solidjs` 行追加.
