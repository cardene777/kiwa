...
- 1d58d62: v2 — @kiwa-lab/ui v0.1.0 新設: React component test adapter (Vitest + Testing Library + JSDOM)

  kiwa 汎用テストツール化 v2 (UI adapter)。
  React component の Layer 1 spec (kiwa-design markdown 9 column) → Layer 2 test code 経路を `@kiwa-lab/ui` adapter で確立する。
