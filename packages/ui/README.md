...
`@kiwa-lab/ui` is the Layer 2 adapter that turns a Layer 1 kiwa-design spec (with `mode = render | interaction | snapshot`) into a runnable Vitest suite. It ships **five** component adapters that share the same lifecycle contract.
...
```tsx
import { setupComponentEnv } from "@kiwa-lab/ui";
...
import { setupSolidComponentEnv } from "@kiwa-lab/ui";
...
import { setupLitComponentEnv } from "@kiwa-lab/ui";
...
import { setupQwikComponentEnv } from "@kiwa-lab/ui";
...
import { setupAngularComponentEnv } from "@kiwa-lab/ui";
...
- [概要](https://cardene777.github.io/kiwa/libraries/foundation/ui/)
- [はじめる](https://cardene777.github.io/kiwa/libraries/foundation/ui/quickstart)
- [使い方](https://cardene777.github.io/kiwa/libraries/foundation/ui/how-to)
- [リファレンス](https://cardene777.github.io/kiwa/libraries/foundation/ui/reference)

編集元は [docs/libraries/foundation/ui](../../docs/libraries/foundation/ui/) です。
<!-- kiwa-docs:end -->
