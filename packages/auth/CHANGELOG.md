...
- dffb701: `@kiwa/auth` v0.1.0 新規 (Issue #637、 v1.8-1)。 NextAuth v5 (Auth.js) 用の test adapter。

  ## What's added

  - `@kiwa/auth` package 新規 (`packages/auth/`)、 peer dep `next-auth@>=5.0.0-beta.0 <6` (Auth.js v5 は beta 継続中のため beta constraint、 stable 到達時に `^5` へ引き上げ)。
  ...
  - PoC ... `examples/auth-nextjs-nextauth-poc/` 新規 (Next.js App Router 相当の Route Handler + `@kiwa/auth` env、 8 test T-AUTH-001 .. T-AUTH-008 all pass)。
  ...
  - Prisma / Drizzle 実 DB integration test → 別 Issue 候補 (`@kiwa/orm` と統合)
