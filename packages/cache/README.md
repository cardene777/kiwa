...
`@kiwa-lab/cache` is the Layer 2 adapter that turns a cache-shaped Layer 1 spec into a runnable Vitest suite. Three factories cover the dominant cache providers:
...
```ts
import { setupMemcachedEnv } from "@kiwa-lab/cache";
...
```ts
import { setupKeyDBEnv } from "@kiwa-lab/cache";
...
- [概要](https://cardene777.github.io/kiwa/libraries/services/cache/)
- [はじめる](https://cardene777.github.io/kiwa/libraries/services/cache/quickstart)
- [使い方](https://cardene777.github.io/kiwa/libraries/services/cache/how-to)
- [リファレンス](https://cardene777.github.io/kiwa/libraries/services/cache/reference)

編集元は [docs/libraries/services/cache](../../docs/libraries/services/cache/) です。
<!-- kiwa-docs:end -->
