...
- [概要](https://cardene777.github.io/kiwa/libraries/foundation/data/)
- [はじめる](https://cardene777.github.io/kiwa/libraries/foundation/data/quickstart)
- [使い方](https://cardene777.github.io/kiwa/libraries/foundation/data/how-to)
- [リファレンス](https://cardene777.github.io/kiwa/libraries/foundation/data/reference)

編集元は [docs/libraries/foundation/data](../../docs/libraries/foundation/data/) です。
<!-- kiwa-docs:end -->
