...
clients via `hc<AppType>(baseUrl)`. `@kiwa-test/hono` gives you standalone
...
import { createHonoApp } from '@kiwa-test/hono';
...
import { createHonoApp, createRpcClient } from '@kiwa-test/hono';
...
Companion: v1.19-1c of the [kiwa test framework](https://github.com/cardene777/kiwa) — released alongside `@kiwa-test/solidjs` (#813) + `@kiwa-test/fresh` (#814) as part of the v1.19 modern framework depth-drive.
