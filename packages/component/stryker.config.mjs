...
export default {
  ...
  mutate: [
    ...
    '.vitest-dist/src/semantics/form-action-advanced.js',
    '.vitest-dist/src/semantics/islands-architecture.js',
    '.vitest-dist/src/semantics/react-19-actions.js',
    '.vitest-dist/src/semantics/rsc-harness.js',
    '.vitest-dist/src/semantics/streaming-ssr.js',
    '.vitest-dist/src/semantics/types.js',
    '.vitest-dist/src/semantics/view-transitions.js',
