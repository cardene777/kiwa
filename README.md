...
| ORM query (Drizzle + SQLite mock + Postgres/MySQL testcontainers + Prisma SQLite、 v0.3) | `/kiwa-design --layer orm-query` | `/kiwa-orm` | `/kiwa-review --layer orm-query` | `@kiwa-test/orm` (Prisma + testcontainers / Kysely / file migration は follow-up Issue CAR-293 残 / CAR-294 / CAR-295) |
