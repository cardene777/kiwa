...
| ORM query (Drizzle + SQLite mock + Postgres testcontainers、 v0.2) | `/kiwa-design --layer orm-query` | `/kiwa-orm` | `/kiwa-review --layer orm-query` | `@kiwa-test/orm` (MySQL / Prisma / Kysely / file migration は follow-up Issue CAR-292 残 / CAR-293 / CAR-294 / CAR-295) |
