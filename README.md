...
| **v1.7** | polyglot 継続深化 — `kiwa-test-rs` v0.4 (tower-http feature、 middleware chain helper + Cors/Trace/Compression/Auth/RateLimit/Timeout 6 middleware) + `kiwa-test-go` v0.4 (fiber subpackage + fasthttp 互換 API) + Layer 1 spec 2 layer 追加 (rust-tower-http + go-fiber) + skill chain 拡張。 v1.5 4 web framework の polyglot 射程を伸ばす | **0/6 resolved** (親 [#621](https://github.com/cardene777/kiwa/issues/621)) | [v1.7 label](https://github.com/cardene777/kiwa/issues?q=is%3Aissue+label%3Av1.7) |
