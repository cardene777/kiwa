...
| ORM query (Drizzle + SQLite、 v0.1 MVP) | `/kiwa-design --layer orm-query` | `/kiwa-orm` | `/kiwa-review --layer orm-query` | `@kiwa-test/orm` (Postgres/MySQL/Prisma/Kysely は follow-up Issue #527-2..N) |
