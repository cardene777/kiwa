...
| **v1.19** | Modern framework depth-drive — `@kiwa-test/solidjs` v0.1 (SolidJS Signal + Effect + createResource + Suspense boundary) + `@kiwa-test/fresh` v0.1 (Deno Fresh Islands + Route Handler + Head normalization) + `@kiwa-test/hono` v0.1 (HonoJS routing + middleware + context). v1.19-1 (#807) は 3 分割 (SolidJS #813 + Fresh #814 + Hono #8xx) で 1 pkg = 1 PR 化 | **2/3 in progress** ([#813](https://github.com/cardene777/kiwa/issues/813) ✅ [#814](https://github.com/cardene777/kiwa/issues/814) ✅ Hono ⏳) — `@kiwa-test/solidjs` v0.1 (42 test) + `@kiwa-test/fresh` v0.1 (58 test) merged | [v1.19 label](https://github.com/cardene777/kiwa/issues?q=is%3Aissue+label%3Av1.19) |
