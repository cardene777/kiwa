...
| **v1.19** | Modern framework depth-drive — `@kiwa-test/solidjs` v0.1 (SolidJS Signal + Effect + createResource + Suspense boundary) + `@kiwa-test/fresh` v0.1 (Deno Fresh Islands + Route Handler + Head normalization) + `@kiwa-test/hono` v0.1 (HonoJS Cloudflare Workers + hc RPC type-safe client + middleware chain). v1.19-1 (#807) は 3 分割 (SolidJS #813 + Fresh #814 + Hono #815) で 1 pkg = 1 PR 化 | **3/3 resolved** ([#813](https://github.com/cardene777/kiwa/issues/813) ✅ [#814](https://github.com/cardene777/kiwa/issues/814) ✅ [#815](https://github.com/cardene777/kiwa/issues/815) ✅) — `@kiwa-test/solidjs` v0.1 (42 test) + `@kiwa-test/fresh` v0.1 (58 test) + `@kiwa-test/hono` v0.1 (89 test) merged | [v1.19 label](https://github.com/cardene777/kiwa/issues?q=is%3Aissue+label%3Av1.19) |
| **v2.0** | multi-version Vitest matrix CI, desktop (Electron / Tauri) + mobile (React Native / Expo) adapters, framework depth (SolidJS / Fresh / HonoJS), coverage 100% milestone, all-framework CI matrix | tbd | [v2.0 label](https://github.com/cardene777/kiwa/issues?q=is%3Aissue+label%3Av2.0) |
