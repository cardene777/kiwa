...
| **v1.3** | 既存 framework adapter の深堀り — Next.js RSC / streaming / Suspense boundary, SvelteKit hooks 全 4 種 (handle / handleError / handleFetch / locals), Astro view transitions test, Remix Resource Routes 追加 helper, Nuxt route middleware 追加 case, ORM follow-up (Prisma + MySQL / Kysely Migrator) を maintenance sub-Issue で吸収 | **0/6 resolved** (親 [#556](https://github.com/cardene777/kiwa/issues/556)) | [v1.3 label](https://github.com/cardene777/kiwa/issues?q=is%3Aissue+label%3Av1.3) |
