...
Real-vs-mock behavioural fidelity for the Grafana-style observability dashboard dogfood, produced by `examples/dogfood-observability-dashboard/tests/emit-fidelity-report.test.ts`. Feeds `@kiwa-test/quality-metrics` 7-axis release gate.
