...
Snapshot from
`examples/dogfood-nats-jetstream/quality-report/fidelity-latest.md`, which is generated locally by `pnpm -F dogfood-nats-jetstream test` and is not tracked in the repository (see #1395).
