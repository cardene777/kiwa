...
Real-vs-mock behavioural fidelity for the Ably collaborative-cursor dogfood, produced by `examples/dogfood-ably-collab-cursor/tests/emit-fidelity-report.test.ts`. Feeds `@kiwa-test/quality-metrics` 7-axis release gate.
