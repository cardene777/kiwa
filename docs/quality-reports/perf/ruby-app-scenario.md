...
|---|---|---|---|---|---|
| rails_crud_workflow (10 dispatch with AR log) | 15024 B | 0 B | 102400 B | yes | PASS |
| multi_framework_batch (4 framework dispatch x2) | 118912 B | 0 B | 102400 B | yes | PASS |
...
|---|---|---|---|---|
| p50 | 0.01ms | 0.01ms | +0.00ms | +7.05% |
| p95 | 0.01ms | 0.01ms | -0.00ms | -16.25% |
| p99 | 0.01ms | 0.01ms | -0.00ms | -27.96% |
| mean | 0.01ms | 0.01ms | -0.00ms | -4.70% |
| min | 0.01ms | 0.01ms | -0.00ms | -2.10% |
| max | 0.01ms | 0.01ms | -0.00ms | -30.09% |
| total | 0.14ms | 0.15ms | -0.01ms | -4.70% |
...
| metric | current | baseline | delta ms | delta % |
|---|---|---|---|---|
| p50 | 0.01ms | 0.01ms | +0.00ms | +0.84% |
| p95 | 0.01ms | 0.01ms | +0.00ms | +10.42% |
| p99 | 0.01ms | 0.01ms | -0.00ms | -0.18% |
| mean | 0.01ms | 0.01ms | -0.00ms | -2.58% |
| min | 0.00ms | 0.00ms | -0.00ms | -2.12% |
| max | 0.01ms | 0.01ms | -0.00ms | -1.89% |
| total | 0.10ms | 0.10ms | -0.00ms | -2.58% |
...
| p95 | 0.00ms | 0.00ms | +0.00ms | +34.22% |
| p99 | 0.00ms | 0.00ms | +0.00ms | +46.52% |
| mean | 0.00ms | 0.00ms | +0.00ms | +4.41% |
| min | 0.00ms | 0.00ms | -0.00ms | -3.54% |
| max | 0.00ms | 0.00ms | +0.00ms | +49.31% |
| total | 0.05ms | 0.05ms | +0.00ms | +4.41% |
