...
Real-vs-mock behavioural fidelity for the OpenAI Chat Completions tool-use agent dogfood, produced by `examples/dogfood-openai-tool-agent/tests/emit-fidelity-report.test.ts`. Feeds `@kiwa-test/quality-metrics` 11-axis release gate.
