...
実例は [tests/fixtures/basic-connect/e2e-test/connect.spec.ts](https://github.com/cardene777/kiwa/blob/main/tests/fixtures/basic-connect/e2e-test/connect.spec.ts) の
`T-E2E-007` を参照してください。
