...
`@kiwa-lab/observability` の `fromIstanbulCoverageSummary` と組み合わせれば、 TS + Python の coverage を 1 つの dashboard に集約できる。
...
- TS 版: [`@kiwa-lab/core`](https://github.com/cardene777/kiwa/blob/main/packages/core/README.md)
