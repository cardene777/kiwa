...
- [`@kiwa-lab/visual` で visual regression](./visual-regression.md) ⭐ v0.9 新設 — pixelmatch + pngjs によるピクセル単位 PNG diff
...
- [tests/docs/write-tests-manually.ja.md](../../../tests/docs/write-tests-manually.ja.md) — skill を使わず `@kiwa-lab/dapp` を library として import して手書きで test を書く手順 (1 file 完結 sample 4 種)
