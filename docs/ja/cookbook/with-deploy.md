...
通常 `@kiwa-lab/dapp` の `dappE2eTest` をそのまま使うところを、 globalSetup 起動済 anvil を共有するため `tests/fixture.ts` 経由に切り替える。
...
- [Quickstart](../quickstart.md) — 最初の 5 分 (`pnpm dlx @kiwa-lab/cli init` 単独版)
