...
A vitest suite wired to `@kiwa-test/component` v0.4 (RSC harness + React 19 Actions) と `@kiwa-test/nextjs` v1.3 (Server Actions v2)、 3 axis × 3 target = 9 grid の workflow を deterministic に扱う pattern。
