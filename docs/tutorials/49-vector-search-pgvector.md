...
import { createVectorStoreSession } from '@kiwa-lab/orm';
...
```ts
import { describe, expect, it } from 'vitest';
import { buildIndex, createVectorStoreSession } from '@kiwa-lab/orm';
