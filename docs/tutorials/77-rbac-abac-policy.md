...
import { createRbacPolicy, rbacAllows } from '@kiwa-test/security';
...
```ts
import { describe, expect, it } from 'vitest';
import { createRbacPolicy, expandRoles, rbacAllows } from '@kiwa-test/security';
...
```ts
import { describe, expect, it } from 'vitest';
import type { AbacPolicy } from '@kiwa-test/security';
import { evaluateAbac } from '@kiwa-test/security';
...
```ts
import { describe, expect, it } from 'vitest';
import type { AbacRule } from '@kiwa-test/security';
import { evaluateAbac } from '@kiwa-test/security';
...
```ts
import { describe, expect, it } from 'vitest';
import { createRbacPolicy, evaluateCombined } from '@kiwa-test/security';
...
```ts
import { describe, expect, it } from 'vitest';
import { toAuthorizationEvent } from '@kiwa-test/security';
