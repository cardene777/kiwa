...
import { bumpSchema, initiateMigration } from '@kiwa-lab/edge';
...
```ts
import { describe, expect, it } from 'vitest';
import { bumpSchema, initiateMigration, migrateInstance } from '@kiwa-lab/edge';
