...
import { createStripeMock, openAccount } from '@kiwa-lab/payment';
...
```ts
import { describe, expect, it } from 'vitest';
import { createStripeMock, openAccount, verifyKyc } from '@kiwa-lab/payment';
...
```ts
import { describe, expect, it } from 'vitest';
import { createStripeMock, openAccount, verifyKyb } from '@kiwa-lab/payment';
...
```ts
import { describe, expect, it } from 'vitest';
import { createBnplPlan, createStripeMock } from '@kiwa-lab/payment';
