...
```ts
import { buildCard, createStoryRegistry } from '@kiwa-test/component';
import type { CardArgs, StoryObj } from '@kiwa-test/component';
...
import { createChromaticVisualMock } from '@kiwa-test/component';
