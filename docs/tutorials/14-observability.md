...
import { createOtelMock } from '@kiwa-lab/observability';
...
```ts
import { describe, expect, it } from 'vitest';
import { createDatadogMock } from '@kiwa-lab/observability';
