...
import { probeAndInvoke } from '@kiwa-test/desktop';
...
```ts
import { describe, expect, it } from 'vitest';
import { probeAndInvokeAll } from '@kiwa-test/desktop';
