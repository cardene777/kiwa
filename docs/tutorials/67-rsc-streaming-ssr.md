...
import { startRscHarness } from '@kiwa-lab/component';
...
```ts
import { describe, expect, it } from 'vitest';
import { beginRscRender, startRscHarness, streamHtmlChunk } from '@kiwa-lab/component';
...
```ts
import { describe, expect, it } from 'vitest';
import { collectFidelityCoverage } from '@kiwa-lab/component';
