...
All 3 test files pass. You now have a passwordless UX observability suite driven by `@kiwa-lab/auth` v0.6 advanced semantics, ready to plug into a real Chromium / WebKit / Firefox WebAuthn stack via `KIWA_MODE=real`.
