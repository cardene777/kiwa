...
import { drillDown, flattenFlame } from '@kiwa-lab/observability';
...
`@kiwa-lab/observability` v2 ships 3 canonical trace shapes covering the flame graphs a debugger walks through most often.
