...
- [Accessibility audit with `@kiwa/a11y`](./a11y-axe.md) ⭐ New in v0.9 — axe-core wrapped for Vitest + jsdom and Playwright pages
- [Visual regression with `@kiwa/visual`](./visual-regression.md) ⭐ New in v0.9 — pixel-level PNG diff (pixelmatch + pngjs)
...
- [tests/docs/write-tests-manually.md](../../../tests/docs/write-tests-manually.md) — Hand-write tests by importing `@kiwa/dapp` as a library (four single-file samples)
