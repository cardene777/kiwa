...
- [Visual regression with `@kiwa-lab/visual`](./visual-regression.md) ⭐ New in v0.9 — pixel-level PNG diff (pixelmatch + pngjs)
...
- [tests/docs/write-tests-manually.md](../../../tests/docs/write-tests-manually.md) — Hand-write tests by importing `@kiwa-lab/dapp` as a library (four single-file samples)
