...
kiwa v1.55 リリース — Mobile 深化 VI (@kiwa-test/mobile v0.6)、 **depth-5 pattern 実装完成** milestone。 v1.54 spawn stub 契約層 → v1.55 実 child_process.spawn 実行、 v0.5 shape 契約 preserving。 kiwa milestone 史上初 6 段拡張 candidate。
