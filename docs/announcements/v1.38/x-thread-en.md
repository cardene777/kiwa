...
@kiwa-lab/ai-llm v0.3.0 → v0.4.0 minor bump. 8 axis advanced AI/LLM production semantics across 4 provider × 8 axis = 32 cell fidelity grid.
...
`pnpm add -D @kiwa-lab/ai-llm` で v0.4.0 が入る. zero breaking changes. migration guide は https://cardene777.github.io/kiwa/migrations/v1.37-to-v1.38
