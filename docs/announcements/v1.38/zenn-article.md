# kiwa v1.38 released — AI/LLM 深化 II (@kiwa/ai-llm v0.4.0 advanced 8 axis + 縦深化 pair 第 10 pair 連続化 + 3 段拡張 3 例目)

## TL;DR

- **kiwa v1.38 released** — AI/LLM 深化 II milestone
- **`@kiwa/ai-llm` v0.3.0 → v0.4.0 minor bump** — advanced 8 axis + real driver env-gate + 4 provider × 8 axis neutral state machine
