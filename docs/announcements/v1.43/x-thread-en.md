...
@kiwa-test/edge v1.1.0 → v1.2.0 minor bump. 3 platform (Cloudflare Workers + Vercel Edge + Deno Deploy) × advanced edge production semantics 8 axis (v1.24 v0.2 8 axis + v1.43 v1.2 8 advanced axis = 48 combination coverage / 16 axis × 3 platform grid).
...
`pnpm add -D @kiwa-test/edge` gets v1.2.0. No breaking changes. Migration guide: https://cardene777.github.io/kiwa/migrations/v1.42-to-v1.43
