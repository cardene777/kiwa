...
2/ @kiwa-test/quality-metrics v0.2 — 11 軸に拡張。

v1.11 の 5 軸 (coverage / test count / fidelity / perf p95 / mutation kill) はそのまま。

AI-LLM provider (name が @kiwa-test/ai- で始まる) は追加 4 軸 — cost.perRequestUsd ≤ $0.10 / latency.p95Ms ≤ 3000 / token.totalTokens ≤ 4000 / accuracy.score ≥ 0.80。

3/ @kiwa-test/ai-llm v0.1 — 4 SDK 統一 mock。
