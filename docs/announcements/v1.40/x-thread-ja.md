...
@kiwa-test/ai-llm v0.4.0 → v0.5.0 minor bump. 4 provider (Anthropic + OpenAI + Vercel AI SDK + LangChain) 上に advanced III AI/LLM production semantics 8 axis を追加 (v1.38 v0.4 advanced 32 cell と合わせて 64 combination coverage).
...
`pnpm add -D @kiwa-test/ai-llm` で v0.5.0 が入る. breaking change なし. migration guide は https://cardene777.github.io/kiwa/migrations/v1.39-to-v1.40
