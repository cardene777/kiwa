...
- **v1.40-6 publish** (Issue #1136, this PR). `.claude-plugin/plugin.json` 1.39.0 → 1.40.0 + description v1.40 marker + AI/LLM advanced III keywords + Roadmap ✅ v1.40 row + announcement 4 file + release-smoke `v1-40-publish.test.ts` + release script filter に `@kiwa/ai-llm` 存在確認 (15 度目の適用).

## Numbers

- **6 sub-Issues resolved** (#1130 / #1132 / #1133 / #1134 / #1135 / #1136)
- **1 npm package minor bump** (`@kiwa/ai-llm` v0.4.0 → v0.5.0)
