...
@kiwa-test/search v0.2 → v0.3 minor bump. 8 axis advanced search semantics across 4 provider × 8 axis = 32 cell fidelity grid.
...
`pnpm add -D @kiwa-test/search` で v0.3.0 が入る. zero breaking changes. migration guide は https://cardene777.github.io/kiwa/migrations/v1.35-to-v1.36
