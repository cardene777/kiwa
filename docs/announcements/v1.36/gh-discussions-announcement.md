# kiwa v1.36 released — Search 深化 II (@kiwa-test/search v0.3.0 + 8 axis advanced search + 3 dogfood app + 縦深化 pair 第 8 pair 連続化 + 14 milestone snippet streak)
...
- **`@kiwa-test/search` v0.2.0 → v0.3.0 minor bump**. v0.2 API は完全維持 (additive-only 契約). v1.13+ single publish surface pattern に沿う single-surface bump.
...
- **v1.36-6 publish** (Issue #1080, this PR). `.claude-plugin/plugin.json` 1.35.0 → 1.36.0 + description v1.36 marker + search keywords + Roadmap ✅ v1.36 row + announcement 4 file + release-smoke `v1-36-publish.test.ts` + release script filter に `@kiwa-test/search` 存在確認 (11 度目の適用).

## Numbers

- **6 sub-Issues resolved** (#1075 / #1081 / #1082 / #1083 / #1084 / #1080)
- **1 npm minor bump** (`@kiwa-test/search` v0.2.0 → v0.3.0)
