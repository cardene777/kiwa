...
@kiwa-test/search v0.2 → v0.3 minor bump. 4 provider (Meilisearch + Typesense + Algolia + OpenSearch) 上に advanced search semantics 8 axis を追加.
...
`pnpm add -D @kiwa-test/search` で v0.3.0 が入る. breaking change なし. migration guide は https://cardene777.github.io/kiwa/migrations/v1.35-to-v1.36
