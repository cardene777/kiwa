...
- **v1.39-6 publish** (Issue #1122, this PR). `.claude-plugin/plugin.json` 1.38.0 → 1.39.0 + description v1.39 marker + security advanced II keywords + Roadmap ✅ v1.39 row + announcement 4 file + release-smoke `v1-39-publish.test.ts` + release script filter に `@kiwa-test/security` 存在確認 (14 度目の適用).

## Numbers

- **6 sub-Issues resolved** (#1116 / #1118 / #1119 / #1120 / #1121 / #1122)
- **1 npm package minor bump** (`@kiwa-test/security` v0.1.0 → v0.2.0)
