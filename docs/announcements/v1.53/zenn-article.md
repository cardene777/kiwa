...
kiwa v1.53 をリリースしました。 **Mobile 深化 IV** (@kiwa-test/mobile v0.4、 縦深化 pair 第 13 の 4 段目 Phase 4 完成、 **pair 深度 4 段拡張達成 4 例目 depth-4 record**、 **depth-4 pattern 4 例安定化を実証**) 単軸 milestone。 11 axis × mock/real = 22 adapter + fidelity harness 追加、 3 target × 11 axis × 2 mode = 66 combination adapter pair の complete production coverage matrix を確立。

## 何が変わったか

### `@kiwa-test/mobile` v0.3 → v0.4 (Phase 4 完成、 pair 深度 4 段拡張達成 4 例目 depth-4 record)
