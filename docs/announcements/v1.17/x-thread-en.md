...
2/ `@kiwa-lab/observability` v2.0 (major bump) — 4 additional axes on top of the v1.1 telemetry mock foundation (v1.14-4 OpenTelemetry / Datadog / Sentry). Zero breaking changes to v1.0 or v1.1 surfaces; 11 new public exports + 13 fixture builders under the "Observability v2" module signal.
