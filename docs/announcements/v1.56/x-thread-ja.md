...
kiwa v1.56 リリース — Desktop 新規 base pair 第 14 導入、 **@kiwa-lab/desktop v0.1** 新規 (Electron + Tauri + Webview 3 axis)、 **42 package 到達**。 v1.50 Mobile と対で **v2.0 milestone desktop + mobile adapters goal 達成**。
