...
@kiwa-lab/security v0.1.0 new package. 8 axis security semantics across 4 provider × 8 axis = 32 cell fidelity grid.
...
`pnpm add -D @kiwa-lab/security` で v0.1.0 が入る. zero breaking changes. migration guide は https://cardene777.github.io/kiwa/migrations/v1.36-to-v1.37
