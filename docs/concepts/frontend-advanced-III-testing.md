...
`@kiwa-lab/component` v0.4 + `@kiwa-lab/nextjs` v1.3 の pair minor bump による Frontend 深化 III 6 axis SSOT。 v1.34 で導入した advanced 4 axis に、 v1.49 で 4 new axis (component 側 2 + nextjs 側 2) 追加、 3 target × 6 axis = 18 row grid に拡張。

## 6 axis 一覧

### component 側 (@kiwa-lab/component v0.4)
