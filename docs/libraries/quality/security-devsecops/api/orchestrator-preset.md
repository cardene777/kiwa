---
title: "@kiwa-lab/security-devsecops orchestrator-preset の API 契約"
---

# <code v-pre>@kiwa-lab/security-devsecops</code> <code v-pre>orchestrator-preset</code> の API 契約
