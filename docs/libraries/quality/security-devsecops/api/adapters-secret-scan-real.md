---
title: "@kiwa-lab/security-devsecops adapters-secret-scan-real の API 契約"
---

# <code v-pre>@kiwa-lab/security-devsecops</code> <code v-pre>adapters-secret-scan-real</code> の API 契約
