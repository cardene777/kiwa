---
title: "@kiwa-lab/security-devsecops semantics-secret-scan の API 契約"
---

# <code v-pre>@kiwa-lab/security-devsecops</code> <code v-pre>semantics-secret-scan</code> の API 契約
