---
title: "@kiwa-lab/security-devsecops adapters__iac-scan-real の API 契約"
---

<!-- kiwa-generated-api-page -->

# <code v-pre>@kiwa-lab/security-devsecops</code> <code v-pre>adapters&#95;&#95;iac-scan-real</code> の API 契約
