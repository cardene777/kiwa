---
title: "@kiwa-lab/edge semantics-kv-eventual-consistency の API 契約"
---

# <code v-pre>@kiwa-lab/edge</code> <code v-pre>semantics-kv-eventual-consistency</code> の API 契約
