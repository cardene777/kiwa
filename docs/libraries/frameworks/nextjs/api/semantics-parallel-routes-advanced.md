---
title: "@kiwa-lab/nextjs semantics-parallel-routes-advanced の API 契約"
---

# <code v-pre>@kiwa-lab/nextjs</code> <code v-pre>semantics-parallel-routes-advanced</code> の API 契約
