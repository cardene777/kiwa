...
[ソース宣言](https://github.com/cardene777/kiwa/blob/main/packages/auth/src/oauth21/authorization-server.ts#L52) <code v-pre>packages/auth/src/oauth21/authorization-server.ts</code>
