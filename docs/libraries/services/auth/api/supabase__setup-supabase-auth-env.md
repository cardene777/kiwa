---
title: "@kiwa-lab/auth supabase__setup-supabase-auth-env の API 契約"
---

<!-- kiwa-generated-api-page -->

# <code v-pre>@kiwa-lab/auth</code> <code v-pre>supabase&#95;&#95;setup-supabase-auth-env</code> の API 契約
