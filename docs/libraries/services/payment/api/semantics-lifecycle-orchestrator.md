---
title: "@kiwa-lab/payment semantics-lifecycle-orchestrator の API 契約"
---

# <code v-pre>@kiwa-lab/payment</code> <code v-pre>semantics-lifecycle-orchestrator</code> の API 契約
