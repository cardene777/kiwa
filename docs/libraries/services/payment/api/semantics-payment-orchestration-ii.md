---
title: "@kiwa-lab/payment semantics-payment-orchestration-ii の API 契約"
---

# <code v-pre>@kiwa-lab/payment</code> <code v-pre>semantics-payment-orchestration-ii</code> の API 契約
