---
title: "@kiwa-lab/payment semantics-subscription-lifecycle の API 契約"
---

# <code v-pre>@kiwa-lab/payment</code> <code v-pre>semantics-subscription-lifecycle</code> の API 契約
