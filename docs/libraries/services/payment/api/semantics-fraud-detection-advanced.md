---
title: "@kiwa-lab/payment semantics-fraud-detection-advanced の API 契約"
---

# <code v-pre>@kiwa-lab/payment</code> <code v-pre>semantics-fraud-detection-advanced</code> の API 契約
