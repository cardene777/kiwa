---
title: "@kiwa-lab/queue rabbitmq-testcontainers-rabbitmq の API 契約"
---

# <code v-pre>@kiwa-lab/queue</code> <code v-pre>rabbitmq-testcontainers-rabbitmq</code> の API 契約
