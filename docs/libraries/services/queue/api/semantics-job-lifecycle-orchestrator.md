---
title: "@kiwa-lab/queue semantics-job-lifecycle-orchestrator の API 契約"
---

# <code v-pre>@kiwa-lab/queue</code> <code v-pre>semantics-job-lifecycle-orchestrator</code> の API 契約
