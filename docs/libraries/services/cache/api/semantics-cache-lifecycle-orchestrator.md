---
title: "@kiwa-lab/cache semantics-cache-lifecycle-orchestrator の API 契約"
---

# <code v-pre>@kiwa-lab/cache</code> <code v-pre>semantics-cache-lifecycle-orchestrator</code> の API 契約
