...
この section は [公開 entry point](https://github.com/cardene777/kiwa/blob/main/packages/skill-test/src/index.ts) から同期しています。各項目は公開名、実際の TypeScript 宣言、宣言元のソース位置を示します。実装に JSDoc がある場合は、その説明も表示します。

### 値

#### `assertToolCalled`

[ソース宣言](https://github.com/cardene777/kiwa/blob/main/packages/skill-test/src/index.ts#L86) `packages/skill-test/src/index.ts`
...
[ソース宣言](https://github.com/cardene777/kiwa/blob/main/packages/skill-test/src/index.ts#L130) `packages/skill-test/src/index.ts`
...
[ソース宣言](https://github.com/cardene777/kiwa/blob/main/packages/skill-test/src/index.ts#L162) `packages/skill-test/src/index.ts`
...
[ソース宣言](https://github.com/cardene777/kiwa/blob/main/packages/skill-test/src/index.ts#L112) `packages/skill-test/src/index.ts`
...
[ソース宣言](https://github.com/cardene777/kiwa/blob/main/packages/skill-test/src/index.ts#L62) `packages/skill-test/src/index.ts`
...
[ソース宣言](https://github.com/cardene777/kiwa/blob/main/packages/skill-test/src/index.ts#L35) `packages/skill-test/src/index.ts`
...
[ソース宣言](https://github.com/cardene777/kiwa/blob/main/packages/skill-test/src/index.ts#L50) `packages/skill-test/src/index.ts`
