---
title: "@kiwa-lab/component semantics-islands-architecture の API 契約"
---

# <code v-pre>@kiwa-lab/component</code> <code v-pre>semantics-islands-architecture</code> の API 契約
