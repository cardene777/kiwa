---
title: "@kiwa-lab/streaming semantics-kafka-raw-protocol の API 契約"
---

# <code v-pre>@kiwa-lab/streaming</code> <code v-pre>semantics-kafka-raw-protocol</code> の API 契約
