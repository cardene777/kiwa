---
title: "@kiwa-lab/streaming semantics-consumer-lag-telemetry の API 契約"
---

# <code v-pre>@kiwa-lab/streaming</code> <code v-pre>semantics-consumer-lag-telemetry</code> の API 契約
