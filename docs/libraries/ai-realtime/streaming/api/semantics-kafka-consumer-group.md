---
title: "@kiwa-lab/streaming semantics-kafka-consumer-group の API 契約"
---

# <code v-pre>@kiwa-lab/streaming</code> <code v-pre>semantics-kafka-consumer-group</code> の API 契約
