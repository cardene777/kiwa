---
title: "@kiwa-lab/ai-llm semantics-prompt-engineering-advanced の API 契約"
---

# <code v-pre>@kiwa-lab/ai-llm</code> <code v-pre>semantics-prompt-engineering-advanced</code> の API 契約
