---
title: "@kiwa-lab/realtime semantics-webrtc-data-channel の API 契約"
---

# <code v-pre>@kiwa-lab/realtime</code> <code v-pre>semantics-webrtc-data-channel</code> の API 契約
