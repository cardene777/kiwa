---
title: "@kiwa-lab/realtime semantics-realtime-ai-inference の API 契約"
---

# <code v-pre>@kiwa-lab/realtime</code> <code v-pre>semantics-realtime-ai-inference</code> の API 契約
