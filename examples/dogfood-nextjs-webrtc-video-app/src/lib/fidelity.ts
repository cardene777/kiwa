 ...
 * token / accuracy) do not apply — WebRTC is a media / transport primitive,
 * not a token-priced generative call. Join / publish / iceRestart latency
 * samples feed `perf.p95Ms` so realtime performance stays visible.
 */
