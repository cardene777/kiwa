/**
 * Adapter resolver — reads `KIWA_MODE` + `LLM_STACK_READY`
 * and returns the correct LLM-obs adapter for the current environment.
 *
...
export function resolveAdapter(opts: ResolveAdapterOptions = {}): LlmOpsAdapter {
