// PoC tests — @kiwa-test/orm v0.7 (Prisma + testcontainers MySQL).

import { afterEach, beforeAll, describe, expect, it } from 'vitest';
import { resolve } from 'node:path';
import { setupOrmEnv, expectRowCount } from '@kiwa-test/orm';
import type { OrmTestEnvLivePrismaMysql } from '@kiwa-test/orm';
...
describe('UsersRepository via @kiwa-test/orm (prisma + testcontainers mysql)', () => {
