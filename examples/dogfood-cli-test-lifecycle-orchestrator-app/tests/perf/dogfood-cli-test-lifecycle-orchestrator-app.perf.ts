...
/**
 * dogfood-cli-test-lifecycle-orchestrator-app dogfood perf test — minimum viable perf baseline。
 ...
 */
describe('dogfood-cli-test-lifecycle-orchestrator-app dogfood perf', () => {
