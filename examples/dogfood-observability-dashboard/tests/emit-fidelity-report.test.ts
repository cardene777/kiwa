...
const buildConfig = () => ({
  dashboardId: 'dogfood-observability-dashboard',
  title: 'kiwa observability dogfood',
  panels: seededPanels,
});

describe('dogfood-observability-dashboard — emit fidelity report to quality-report/', () => {
  it('T-DFO-EM-001 writes JSON snapshot + markdown report to disk', async () => {
    ...
    // Dashboard provider means the 7-axis gate must have run.
