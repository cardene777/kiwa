 ...
 * `@kiwa-lab/observability` {@link DashboardMock} in mock mode) only
 ...
 * `@kiwa-lab/observability` DashboardMock + TelemetryCollector). Both
 ...
 * refresh cadence + query latency into `@kiwa-lab/quality-metrics`.
 */
