 ...
 * mode, the kiwa `@kiwa-lab/observability` {@link AlertRouter} in mock
 ...
 * `@kiwa-lab/observability` `AlertRouter` + `TelemetryCollector`). Both
 ...
 * routing latency into `@kiwa-lab/quality-metrics`.
 */
