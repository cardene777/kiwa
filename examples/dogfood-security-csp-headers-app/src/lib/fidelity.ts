 ...
 * `@kiwa-lab/security` v0.1 helpers track the real Next.js 15.4 + React
 ...
 * accuracy) do not apply. CSP / violation / headers latency samples feed
...
export interface FidelityRunInput {
  ...
  /**
   * How many mock methods the app exercised vs the CSP + violation + advanced
   * security headers surface — 15 ops (startCsp / attachNonce / attachHash /
   * applyStrictDynamic / applyTrustedTypes / emitCspHeader / startViolation /
   * ingestViolation / recordViolationEvent / closeViolation / startHeaders /
   * applyHsts / applyReferrerPolicy / applyPermissionsPolicy /
   * emitHeaderBundle) are the AC scope of Sub-Issue CAR-826.
   */
