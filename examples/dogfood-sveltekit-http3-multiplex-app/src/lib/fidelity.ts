 ...
 * token / accuracy) do not apply — HTTP/3 is a transport primitive, not a
 * token-priced generative call. Connection open / stream open / write /
 * concurrent-send latency samples feed `perf.p95Ms` so transport performance
 * stays visible.
 */
