...
src/
  ...
  adapters/
    ...
    mock.ts         -- kiwa mock adapter (@kiwa/mcp McpServer + @kiwa/ai-llm createAnthropicMock)
...
- v1.15-2 `@kiwa/mcp` v0.1 (`packages/mcp/`)
