...
src/
  ...
  adapters/
    ...
    mock.ts         -- kiwa mock adapter (@kiwa-test/mcp McpServer + @kiwa-test/ai-llm createAnthropicMock)
...
- v1.15-2 `@kiwa-test/mcp` v0.1 (`packages/mcp/`)
