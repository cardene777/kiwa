/**
 * Adapter resolver — reads `KIWA_MODE` + `OPENAI_API_KEY` +
 * `KIWA_LLM_BUDGET_USD` and returns the correct LLM quality adapter for
...
import type { LlmQualityAdapter } from '../adapters/interface.js';
