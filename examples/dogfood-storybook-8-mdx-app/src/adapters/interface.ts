 ...
 * `@kiwa-lab/component` `createStoryRegistry` + in-process MdxRegistry +
 ...
 * fed to `@kiwa-lab/quality-metrics` 7-axis release gate.
 *
...
import type { A11yViolation, StoryMeta } from '@kiwa-lab/component';
