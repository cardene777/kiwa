...
/**
 * dogfood-cloudflare-workers-durable-object-app dogfood perf test — minimum viable perf baseline。
 ...
 */
describe('dogfood-cloudflare-workers-durable-object-app dogfood perf', () => {
