...
/**
 * dogfood-auth-session-lifecycle-orchestrator-app dogfood perf test — minimum viable perf baseline。
 ...
 */
describe('dogfood-auth-session-lifecycle-orchestrator-app dogfood perf', () => {
