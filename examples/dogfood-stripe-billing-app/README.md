...
advanced billing. Wires `@kiwa-test/payment` v0.3 mock adapter + 9-axis
...
│   ├── mock.ts         — @kiwa-test/payment stripe mock
...
```
KIWA_MODE=mock  (default) — @kiwa-test/payment createStripeMock + 9-axis semantics
