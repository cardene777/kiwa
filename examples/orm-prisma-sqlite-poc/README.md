...
`@kiwa-test/orm` v0.3 を **Prisma + SQLite (file-based in isolated tempdir)** で使う PoC。 既存 Drizzle 経路 (SQLite mock / Postgres / MySQL live) と同じ `setupOrmEnv` API で Prisma adapter を呼出す reference。
...
# → 1) @kiwa-test/orm build  2) prisma generate  3) vitest run
...
- runtime fixture ... [`@kiwa-test/orm`](../../packages/orm/README.md) v0.3
