...
/**
 * dogfood-quality-metrics-adaptive-threshold-app dogfood perf test — minimum viable perf baseline。
 ...
 */
describe('dogfood-quality-metrics-adaptive-threshold-app dogfood perf', () => {
