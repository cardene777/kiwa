// PoC tests — @kiwa-test/orm v0.6 (Prisma + testcontainers Postgres).

import { afterEach, beforeAll, describe, expect, it } from 'vitest';
import { resolve } from 'node:path';
import { setupOrmEnv, expectRowCount } from '@kiwa-test/orm';
import type { OrmTestEnvLivePrismaPostgres } from '@kiwa-test/orm';
...
describe('UsersRepository via @kiwa-test/orm (prisma + testcontainers postgres)', () => {
