 ...
 * `@kiwa-lab/streaming`'s RedpandaMock + SchemaRegistry) and
 ...
 * side and fed to `@kiwa-lab/quality-metrics` 13-axis release gate.
 */

import type { CompatibilityMode } from '@kiwa-lab/streaming';
