/**
 * Adapter resolver — reads `KIWA_MODE` + `EMBEDDED_FINANCE_STACK_READY`
 * and returns the correct Payment adapter for the current environment.
 *
...
export function resolveAdapter(opts: ResolveAdapterOptions = {}): PaymentAdapter {
