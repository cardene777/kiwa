...
`@kiwa-lab/orm` v0.2.1 を **Drizzle ORM + MySQL (testcontainers)** で使う PoC。 同じ `UsersRepository` を Postgres / MySQL 経路で動かす dialect 横断 reference。
...
- runtime fixture ... [`@kiwa-lab/orm`](../../packages/orm/README.md) v0.2.1
