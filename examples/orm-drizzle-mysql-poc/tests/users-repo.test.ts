// PoC tests — @kiwa-test/orm v0.2.1 (Drizzle + MySQL via testcontainers).

import { afterEach, beforeAll, describe, expect, it } from 'vitest';
import { eq } from 'drizzle-orm';
import { setupOrmEnv, expectRowCount } from '@kiwa-test/orm';
import type { OrmTestEnvLiveMysql } from '@kiwa-test/orm';
...
describe('UsersRepository via @kiwa-test/orm (mysql testcontainers)', () => {
