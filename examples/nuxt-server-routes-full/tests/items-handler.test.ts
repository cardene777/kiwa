...
// — invokes the pure handler through @kiwa-test/nuxt's invokeEventHandler.
...
import { invokeEventHandler } from '@kiwa-test/nuxt';
import { itemsHandler } from '../server/api/_kiwa/items-handler.js';

describe('itemsHandler via @kiwa-test/nuxt invokeEventHandler', () => {
