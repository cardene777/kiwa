...
export const SEED_DOCS: SeedDoc[] = [
  {
    ...
    content:
      ...
      'It ships as a pnpm workspace with @kiwa-lab/* packages covering dApp e2e, RabbitMQ workers, Supabase auth, AI-LLM SDK mocks, and quality-metrics release gate. ' +
  ...
  },
  {
    ...
    title: '@kiwa-lab/ai-llm harness',
    content:
      '@kiwa-lab/ai-llm ships four SDK-shape mocks — createAnthropicMock, createOpenAIMock, createVercelAiMock, and createLangchainMock — that emit the same response shape as the real SDKs so dogfood apps can swap them under KIWA_MODE. ' +
  ...
  },
  {
    ...
    content:
      ...
      'The dogfood apps use the same @kiwa-lab/quality-metrics 11-axis release gate so their pass / fail verdicts are directly comparable. ' +
