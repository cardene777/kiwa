 ...
 * `KIWA_MODE=mock` (`@kiwa-test/ai-llm` createVercelAiMock +
...
export const RAG_QA_PAIRS: Array<{
  ...
  },
  {
    ...
    groundTruth: '11 axes when the provider starts with @kiwa-test/ai-llm — 7 base plus 4 AI-LLM specific.',
  },
  {
  ...
  {
    question: 'Which SDK mocks does @kiwa-test/ai-llm provide?',
