...
中で起こること — `pnpm -F @kiwa-test/dapp build` で fixture dist 更新 → `playwright test` (Next.js dev server を port 3042 で起動 + anvil 起動 + EntryPoint / Factory / Smart Account deploy)。
