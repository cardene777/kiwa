...
Internally: `pnpm -F @kiwa-lab/dapp build` refreshes the fixture dist → `playwright test` boots Next.js on port 3042 + starts anvil + deploys EntryPoint / Factory / Smart Account.
