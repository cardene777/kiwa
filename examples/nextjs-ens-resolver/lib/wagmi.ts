...
const ANVIL_PORT = Number(process.env.NEXT_PUBLIC_ANVIL_PORT ?? 8563);
...
const connectors = connectorsForWallets(
  ...
  {
    appName: 'dapp-e2e nextjs-ens-resolver',
...
export const RESOLVER = requireEnv(process.env.NEXT_PUBLIC_RESOLVER, 'NEXT_PUBLIC_RESOLVER');
...
// 各 test fresh 起動の anvil でユニークな name を使うため test ごとに timestamp 接尾辞を付ける想定
export const DEFAULT_NAME_PREFIX = 'alice';
