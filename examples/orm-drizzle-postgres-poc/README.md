...
`@kiwa-lab/orm` v0.2 を **Drizzle ORM + Postgres (testcontainers)** で使う PoC。 v0.1 の SQLite mock 経路と同じ Pattern A (DI) で `UsersRepository` を 8 test cover。
...
- runtime fixture ... [`@kiwa-lab/orm`](../../packages/orm/README.md) v0.2
