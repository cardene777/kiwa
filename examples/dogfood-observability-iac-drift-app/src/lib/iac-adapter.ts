/**
 * Adapter resolver — reads `KIWA_MODE` + `IAC_STACK_READY`
 * and returns the correct IaC adapter for the current environment.
 *
...
export function resolveAdapter(opts: ResolveAdapterOptions = {}): IacAdapter {
