...
// — renders the async RSC through @kiwa-test/nextjs's renderServerComponent.

import { describe, expect, it } from 'vitest';
import { renderServerComponent, findAll, textContent } from '@kiwa-test/nextjs';
import { ItemsPageRSC } from '../app/items/_kiwa/items-rsc.js';

describe('ItemsPageRSC via @kiwa-test/nextjs renderServerComponent', () => {
