...
import { createStoryRegistry, type StoryRegistry } from '@kiwa-lab/component';

/**
 * Mock adapter — drives Playwright Component Testing through
 * `@kiwa-lab/component` `createPlaywrightCTMock` (mount + interact + assert
 ...
 * the heuristic checker inside `@kiwa-lab/component` is exposed through the
  ...
  return {
    ...
    async checkA11y<K extends FormKind>(
      ...
      return timed('checkA11y', async () => {
        ...
        // heuristic a11y checker inside `@kiwa-lab/component` can walk the
