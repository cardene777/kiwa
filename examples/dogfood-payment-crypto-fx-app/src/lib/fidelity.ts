 ...
 * `@kiwa-test/payment` v0.5 crypto-payment + fx-cross-border helpers
 ...
 * 4 axes (cost / latency / token / accuracy) do not apply. Invoice / fx
...
export interface FidelityRunInput {
  ...
  /**
   * How many mock methods the app exercised vs the invoice + fx surface —
   * 14 ops (startInvoice / createInvoice / confirmTx / abstractGas /
   * linkWallet / checkInvoiceStatus / closeInvoice / startFx / lockRate /
   * initiateSettlement / completeSettlement / expireRate / checkFxStatus /
   * closeFx) are the AC scope of Issue CAR-980.
   */
