...
Proof of concept for `@kiwa-test/nextjs` middleware mode (Issue #495). Tests three real-world middleware patterns — auth gate, locale rewrite, header inject — through `invokeMiddleware` without a running Next.js server.
