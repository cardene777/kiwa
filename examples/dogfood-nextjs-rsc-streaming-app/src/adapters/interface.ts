 ...
 *  - {@link makeMockAdapter} — backed by `@kiwa-test/component` v0.3 rsc-
 *    harness + streaming-ssr + view-transitions + form-action-advanced
 *    semantics and `@kiwa-test/nextjs` v1.2 `renderServerComponent` +
 ...
 * that `@kiwa-test/component` v0.3 + `@kiwa-test/nextjs` v1.2 expose in
 * production.
 *
