/**
 * Adapter resolver — reads `KIWA_MODE` + `RSC_STREAMING_BROWSER_READY` and
 * returns the correct RSC streaming adapter for the current environment.
 *
...
export function resolveAdapter(opts: ResolveAdapterOptions = {}): RscStreamingAdapter {
