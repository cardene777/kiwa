...
`@kiwa-test/orm` v0.4 を **Kysely query builder + in-memory SQLite (better-sqlite3)** で使う PoC。 既存 Drizzle / Prisma 経路と同じ `setupOrmEnv` API で Kysely 経路を呼出す reference。
...
- runtime fixture ... [`@kiwa-test/orm`](../../packages/orm/README.md) v0.4
