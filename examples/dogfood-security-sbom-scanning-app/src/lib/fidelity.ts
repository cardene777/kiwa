 ...
 * `@kiwa-test/security` v0.1 sbom + secrets-scan helpers track the real
 ...
 * accuracy) do not apply. SBOM / secrets / scanner latency samples feed
...
export interface FidelityRunInput {
  ...
  /**
   * How many mock methods the app exercised vs the SBOM + secrets +
   * scanner surface — 14 ops (startSbom / addComponent / emitCycloneDx /
   * emitSpdx / validateSbom / evaluateLicense / closeSbom / startSecrets /
   * scanSource / trackRotation / markRotated / closeSecrets /
   * lookupAdvisories / buildReport) are the AC scope of Sub-Issue CAR-828.
   */
