...
`fast-check` を Hardhat 環境で使う property test の実装パターン。 `/kiwa-hardhat` Step 4 で本 file を Read する。
...
- Foundry 並立 (fuzz pattern): `.claude/skills/kiwa-forge/references/fuzz-invariant-patterns.md`
