...
SSOT (`docs/SKILL-DESIGN.ja.md` § Step 3) の 10 観点を Hardhat の helper / chai matchers / 規約に変換する完全マッピング。 `/contract-test-hardhat` Step 3 で本 file を Read する。
...
- Foundry 並立 skill: `.claude/skills/contract-test-foundry/SKILL.md`
