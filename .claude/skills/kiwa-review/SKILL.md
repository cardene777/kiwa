...
description: |
  ...
  v1.4-6 (Issue #581) で polyglot 4 layer (rust-unit / rust-integration / go-unit / go-integration) 対応追加、 v1.5-6 (Issue #597) で polyglot 縦深化 4 layer (rust-axum / rust-actix-web / go-gin / go-echo) 対応追加、 5 言語 (TS / Python / Solidity / Rust / Go) + 4 web framework (axum / actix-web / gin / echo) の spec vs test 整合 review を統一経路で扱う。
