...
Playwright + @kiwa/dapp fixture で wallet inject auto。 PR #229 の 3 helper (waitForWalletConnected / injectMultipleWallets / setStorageSlot) を opt-in 利用可能 (TC-E024 / E025 で setStorageSlot / injectMultipleWallets が有用)。
