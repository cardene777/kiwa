...
export const A11Y_PACKAGE_TIER = Object.freeze({
  ...
  '@kiwa/perf-harness': { tier: 'core' },
  '@kiwa/quality-metrics': { tier: 'core' },
  '@kiwa/release-invariants': { tier: 'core' },
...
const PKG_DIRS = Object.freeze({
  ...
  '@kiwa/release-invariants': 'packages/release-invariants',
...
/** Extract the baseline JSON basename from the package name (`@kiwa/x` → `x`). */
